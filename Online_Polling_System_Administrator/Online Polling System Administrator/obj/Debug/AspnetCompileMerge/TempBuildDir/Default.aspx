...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <p>
                <asp:Button ID="newelectionBtn" runat="server" Text="Manage Elections" CssClass="btn btn-default" ForeColor="#996600" PostBackUrl="~/Manage_elections.aspx"/>
            </p>
        </div>
        <div class="col-md-4">
            ...
            <p>
                <asp:Button ID="electoralpostBtn" runat="server" Text="Manage Election Posts" CssClass="btn btn-default" ForeColor="#996600" PostBackUrl="~/Manage_Post.aspx" /> 
            </p>
        </div>
        <div class="col-md-4">
            ...
            <p>
                <asp:Button PostBackUrl="~/ManageCandidates.aspx" ID="addcandidateBtn" runat="server" Text="Manage Candidates" CssClass="btn btn-default" ForeColor="#996600" />
            </p>
        </div>
    </div>
    <div class="row">
        <div class="col-md-4">
            ...
            <p>
                <asp:Button ID="Button1" PostBackUrl="~/ElectionOverview.aspx" runat="server" Text="Election Overview" CssClass="btn btn-default" ForeColor="#996600" />
            </p>
        </div>
        <div class="col-md-4">
            <h2>New Candidate</h2>
            ...
            <p>
                <asp:Button ID="Button3" PostBackUrl="~/NewCandidate.aspx" runat="server" Text="New Candidate" CssClass="btn btn-default" ForeColor="#996600" />
            </p>
        </div>
        <div class="col-md-4">
            ...
            <p>
                <asp:Button ID="Button2" PostBackUrl="~/Account/Register.aspx" runat="server" Text="New Admin" CssClass="btn btn-default" ForeColor="#996600" />
            </p>
        </div>
    </div>
    <br />
