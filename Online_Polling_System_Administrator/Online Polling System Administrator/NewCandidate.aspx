...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
     <div>
        ...
        <div class="row">
            ...
            <div>
                <asp:Label ID="Label8" runat="server" Text="Level" CssClass="control-label" Font-Bold="true" ForeColor="#996600"></asp:Label>
                <div>
                    <asp:DropDownList ID="levelDrp" runat="server" CssClass="col-md-10 form-control" ></asp:DropDownList>
                    <br />
                    <br />
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ControlToValidate="levelDrp" runat="server" CssClass="text-danger" ErrorMessage="level field must be filled!!!"></asp:RequiredFieldValidator>
                </div>
            </div>
            <div>
